// src/renderer/pages/loyalty/components/LoyaltyActionsDropdown.tsx
import React, { useRef, useEffect, useState } from "react";
import { Eye, MoreVertical } from "lucide-react";
import type { LoyaltyTransaction } from "../../../api/core/loyalty";

interface LoyaltyActionsDropdownProps {
  transaction: LoyaltyTransaction;
  onView: (transaction: LoyaltyTransaction) => void;
}

const LoyaltyActionsDropdown: React.FC<LoyaltyActionsDropdownProps> = ({
  transaction,
  onView,
}) => {
  ...
  return (
    <div className="loyalty-actions-dropdown-container" ref={dropdownRef}>
      <button
        ref={buttonRef}
        onClick={(e) => {
          e.stopPropagation();
...
export default LoyaltyActionsDropdown;