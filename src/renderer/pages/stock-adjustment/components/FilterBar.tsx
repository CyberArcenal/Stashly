// src/renderer/pages/stock-adjustment/components/FilterBar.tsx
import React from "react";
import { Calendar, X } from "lucide-react";
import type { AdjustmentFilters } from "../hooks/useStockAdjustment";
import type { Warehouse } from "../../../api/core/warehouse";

interface FilterBarProps {
  filters: AdjustmentFilters;
  onFilterChange: (key: keyof AdjustmentFilters, value: string) => void;
  onReset: () => void;
