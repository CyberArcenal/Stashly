// src/renderer/pages/stock-items/hooks/useEditThreshold.ts
import { useState } from "react";
import type { StockItemWithDetails } from "./useStockItems";

interface UseEditThresholdReturn {
  isOpen: boolean;
...
const useEditThreshold = (): UseEditThresholdReturn => {
...
export default useEditThreshold;